# Payment reporting system (Made and tested on Ubuntu 14.04 (PHP, MySQL and a little bit of bash :) )

***

Структура документа

1. [Алгоритм извлечения данных](#one)
2. [Инструкция по установке приложения(для тестирования работы программы)](#Инструкция по установке приложения(для тестирования работы программы))
3. Планировщик задач(ответ на вопрос о запуске скрипта в указанное время)
4. Пожелания для улучшения архитектуры(маленький импрувмент)
